...
func _on_button_up() -> void:
	if Global.Location == "La Paz Hospital" and Global.subLocation == "Morgue" and Global.Clara_in_photos == 0 :
	...
	elif Global.Location == "La Paz Hospital" and Global.subLocation == "Morgue" and Global.Clara_in_photos == 1 :
